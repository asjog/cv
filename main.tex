...
\usepackage[url=false,
    ...
    maxnames=10,                                    % Amount of authors to include before abbreviating.
    sorting=ydnt,
    firstinits=true,
    ]{biblatex}                         % Sorting in reverse order
\DeclareNameAlias{author}{last-first}

\addbibresource{amod_papers_v2_bibtex.bib}                   % Include your bibtex file here. Format: fileName.bib
...
Medical image analysis, image synthesis, super-resolution, biological motion analysis
\section{Education}
\cventry{2009--2016}{Doctor of Philosophy in Computer Science}{The Johns Hopkins University~(JHU)}{Baltimore}
...
\cventry{2016--2017}{Postdoctoral Fellow}{Image Analysis and Communications Laboratory}{}{}{}
...
\item Managed a team of 6 course assistants for teaching, grading, assignments and solutions formulation
\end{itemize}
}
\subsection{Service}
